...
class appTestDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_07f531071912874c6d29d7d1dafbb2a5085eaa6dcccaad7c7816f21cbb5e7635');
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_000000003e911be7000000006f02d97e9590c2501d86c945fc3e3d84616dc208(
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_000000003e911be0000000006f02d97e9590c2501d86c945fc3e3d84616dc208(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
...
class VichUploaderBundleHandlerDownloadHandler_000000003e911be7000000006f02d97e9590c2501d86c945fc3e3d84616dc208 extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5748039d874c1136478902 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5748039d87518786001023 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5748039d8744a694568271 = array(
    ...
    {
        $this->initializer5748039d87518786001023 && $this->initializer5748039d87518786001023->__invoke($this->valueHolder5748039d874c1136478902, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer5748039d87518786001023);

        return $this->valueHolder5748039d874c1136478902->downloadObject($object, $field, $className, $fileName);
    }
    ...
    {
        $this->initializer5748039d87518786001023 = $initializer;
    }
    ...
    {
        $this->initializer5748039d87518786001023 && $this->initializer5748039d87518786001023->__invoke($this->valueHolder5748039d874c1136478902, $this, '__get', array('name' => $name), $this->initializer5748039d87518786001023);

        if (isset(self::$publicProperties5748039d8744a694568271[$name])) {
            return $this->valueHolder5748039d874c1136478902->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5748039d874c1136478902;
    ...
    {
        $this->initializer5748039d87518786001023 && $this->initializer5748039d87518786001023->__invoke($this->valueHolder5748039d874c1136478902, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5748039d87518786001023);
    ...
    {
        $this->initializer5748039d87518786001023 && $this->initializer5748039d87518786001023->__invoke($this->valueHolder5748039d874c1136478902, $this, '__isset', array('name' => $name), $this->initializer5748039d87518786001023);
    ...
    {
        $this->initializer5748039d87518786001023 && $this->initializer5748039d87518786001023->__invoke($this->valueHolder5748039d874c1136478902, $this, '__unset', array('name' => $name), $this->initializer5748039d87518786001023);
    ...
    {
        $this->initializer5748039d87518786001023 && $this->initializer5748039d87518786001023->__invoke($this->valueHolder5748039d874c1136478902, $this, '__clone', array(), $this->initializer5748039d87518786001023);

        $this->valueHolder5748039d874c1136478902 = clone $this->valueHolder5748039d874c1136478902;
    }

    public function __sleep()
    {
        $this->initializer5748039d87518786001023 && $this->initializer5748039d87518786001023->__invoke($this->valueHolder5748039d874c1136478902, $this, '__sleep', array(), $this->initializer5748039d87518786001023);

        return array('valueHolder5748039d874c1136478902');
    }
    ...
    {
        return $this->initializer5748039d87518786001023;
    }
    ...
    {
        return $this->initializer5748039d87518786001023 && $this->initializer5748039d87518786001023->__invoke($this->valueHolder5748039d874c1136478902, $this, 'initializeProxy', array(), $this->initializer5748039d87518786001023);
    }
    ...
    {
        return null !== $this->valueHolder5748039d874c1136478902;
    }
    ...
    {
        return $this->valueHolder5748039d874c1136478902;
    }


}

class VichUploaderBundleHandlerUploadHandler_000000003e911be0000000006f02d97e9590c2501d86c945fc3e3d84616dc208 extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5748039d8da33682963550 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5748039d8da71316591484 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5748039d8d9c3526517996 = array(
    ...
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5748039d8da71316591484);

        return $this->valueHolder5748039d8da33682963550->upload($obj, $fieldName);
    }
    ...
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5748039d8da71316591484);

        return $this->valueHolder5748039d8da33682963550->inject($obj, $fieldName);
    }
    ...
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5748039d8da71316591484);

        return $this->valueHolder5748039d8da33682963550->clean($obj, $fieldName);
    }
    ...
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5748039d8da71316591484);

        return $this->valueHolder5748039d8da33682963550->remove($obj, $fieldName);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer5748039d8da71316591484 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, '__get', array('name' => $name), $this->initializer5748039d8da71316591484);

        if (isset(self::$publicProperties5748039d8d9c3526517996[$name])) {
            return $this->valueHolder5748039d8da33682963550->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5748039d8da33682963550;
    ...
    public function __set($name, $value)
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5748039d8da71316591484);
    ...
    public function __isset($name)
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, '__isset', array('name' => $name), $this->initializer5748039d8da71316591484);
    ...
    public function __unset($name)
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, '__unset', array('name' => $name), $this->initializer5748039d8da71316591484);
    ...
    public function __clone()
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, '__clone', array(), $this->initializer5748039d8da71316591484);

        $this->valueHolder5748039d8da33682963550 = clone $this->valueHolder5748039d8da33682963550;
    }

    public function __sleep()
    {
        $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, '__sleep', array(), $this->initializer5748039d8da71316591484);

        return array('valueHolder5748039d8da33682963550');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5748039d8da71316591484;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer5748039d8da71316591484 && $this->initializer5748039d8da71316591484->__invoke($this->valueHolder5748039d8da33682963550, $this, 'initializeProxy', array(), $this->initializer5748039d8da71316591484);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5748039d8da33682963550;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5748039d8da33682963550;
    }
